  ...
  return (
    <section className="playerContainer bg-dark-gray h-100 text-light">
      <header className="music-header d-flex justify-content-between align-items-center">
        <h1>
          Most Popular{" "}
          <small className="fs-5 text-gray fw-medium">24 songs</small>
        </h1>
        <div className="musicType fs-4 text-gray fw-medium">
          Juzz, R&B, Morden
        </div>
      </header>
      <section className="playing">
        <AllMusic
          num="01"
          photo={imaginedragons}
          artistName="Imagine Dragons"
          title="Enemy (From Arcane League of Legends Series)"
          time="02:57"
          like={
            <svg
          ...
          <div className="d-flex gap-4 align-items-center">
            <button>
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-skip-backward-fill text-gray"
                viewBox="0 0 16 16"
              >
            ...
            <button>
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-skip-forward-fill text-gray"
                viewBox="0 0 16 16"
              >
          ...
          <div className="d-flex align-items-center gap-4">
            <button>
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-shuffle text-gray"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
            ...
            <button>
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-arrow-counterclockwise text-gray"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
